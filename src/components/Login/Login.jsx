...
export default function Login() {
  ...
  try {
    const response = await axios.post("http://localhost:8000/api/auth/login", userCred, {
      headers: {
    ...
    navigate("/dashboard"); // 👉 التوجيه هنا
  ...
  <div className="d-flex flex-column flex-md-row justify-content-between align-items-center vh-100 pt-4 pt-md-5 px-3 px-md-5">
    ...
    <div className="position-absolute bottom-0 start-0 p-4 text-start w-100">
      ...
      <p className="fs-6 fs-md-5 text-light m-0">
        ...
        <span className="fw-bold main">BabyWhisper</span> to decode your baby's
    ...
    <div className="w-100 w-md-50 order-1 order-md-1">
      <div className="d-flex flex-column gap-4">
        <h1 className="text-center font-main text-blue header fs-4 fs-md-2">Welcome Back!</h1>
        <div className="d-flex flex-column align-items-center gap-3">
          ...
          <button className="w-100 w-md-50 p-2 font-third rounded-pill d-flex align-items-center justify-content-center gap-2">
            ...
            <span className="text-light-blue fs-6">Sign in with Facebook</span>
          </button>
        </div>
      ...
      <form onSubmit={formik.handleSubmit} className="mt-4">
        <div className="container">
          <div className="mb-3">
            <label htmlFor="exampleInputEmail1" className="form-label fw-bold text-blue font-second fs-6">
              Email
            </label>
            <input
              type="email"
          ...
          <div className="mb-3">
            <label htmlFor="exampleInputPassword1" className="form-label fw-bold text-blue font-second fs-6">
              Password
            </label>
          ...
          <div className="mb-3 d-flex align-items-center justify-content-between flex-wrap">
            <div className="d-flex align-items-center gap-1">
              ...
              />
              <label className="form-check-label cursor-pointer fs-6" htmlFor="exampleCheck1">
                Remember me
              </label>
            </div>
            <div>
