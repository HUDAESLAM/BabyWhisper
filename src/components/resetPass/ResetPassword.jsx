...
export default function ResetPassword() {
  ...
  const [savedEmail] = useState(() => localStorage.getItem("resetEmail") ?? "");
  ...
  const verifyFormik = useFormik({
    ...
    onSubmit: async (values, { setSubmitting }) => {
      try {
        await axios.post("http://localhost:8000/api/auth/VerifyResetCode", {
  ...
  const passwordFormik = useFormik({
    ...
    onSubmit: async (values, { setSubmitting }) => {
      try {
        await axios.post("http://localhost:8000/api/auth/resetPassword", {
          email: values.email,
          ...
          <div className="col-md-6">
            {step === "verify" ? (
              ...
              >
                ...
                <div className="mb-3">
                  <label htmlFor="resetCode" className="form-label text-light-blue">
                    Reset Code
                  </label>
                  <input
                    type="text"
              ...
              >
                ...
                {/* Email */}
                <div className="mb-3">
                  <label htmlFor="email" className="form-label text-light-blue">
                    Email
                  </label>
                  <input
                    type="email"
                ...
                <div className="mb-3 position-relative">
                  <label htmlFor="newPassword" className="form-label text-light-blue">
                    New Password
                  </label>
                  <input
                ...
                {/* Confirm Password */}
                <div className="mb-3">
                  <label htmlFor="confirmPassword" className="form-label text-light-blue">
                    Confirm Password
                  </label>
                  <input
                    type={showPassword ? "text" : "password"}
